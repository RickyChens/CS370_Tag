...
args1 =[sys.executable, "-m", "pong2_client", '--id=1']
args2 =[sys.executable, "-m", "pong2_client", '--id=2']
...
for idx, hwnd_info in enumerate(hwnds):
    if hwnd_info is None:
        print(f"No window handle found for process {idx}")
        continue
    hwnd, cpid, rect = hwnd_info
